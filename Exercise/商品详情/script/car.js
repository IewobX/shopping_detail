                ...
                success:function(msg){
                    ...
                    if(list === null){
                        ...
                        for(let i=0;i<list.length;i++){
                            ...
                            let text = "<li class='item'><input type='checkbox' class='checked' onclick='checkout_sum()' />"+
...
function min1(obj){
    ...
    total(parent);
    checkout_sum();
    // console.log(idlist[$('.item').index(obj.parentNode.parentNode.parentNode)]);
    commodityid = idlist[$('.item').index(obj.parentNode.parentNode.parentNode)];    
    $.ajax({
        type: "put",
        url: "/kys24/cart/commodities?"+'commodityid='+commodityid+'&num='+parent.children[1].value,
        data: '',
    });
}
function add1(obj){
...
function deleteElement(obj){
    ...
    if(r){
        console.log($('.item').index(obj.parentNode.parentNode.parentNode   ));
